...
/**
 * IPC_same_war_receive Portlet Class
 */
public class IPC_same_war_receive extends GenericPortlet {
    ...
    public void doView(RenderRequest request, RenderResponse response) throws PortletException, IOException {
        ...
        writer.println("<h2>IPC (Same WAR) text string received :</h2>" + this.getTextValue());
    ...
    public void handleProcessPersonEvent(javax.portlet.EventRequest request, javax.portlet.EventResponse response) throws javax.portlet.PortletException, java.io.IOException {
        javax.portlet.Event event = request.getEvent();
        person = (TestPerson) event.getValue();
    }
