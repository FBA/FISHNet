...
import org.freshwaterlife.portlets.dataset.resulttypes.Dataset;
...
public class Red extends Dataset implements Serializable {
	...
	if (values.containsKey("mods.abstract")) {
	    setModsAbstract((String) values.get("mods.abstract"));
	}
	if (values.containsKey("roleIds")) {
		...
		this.setUploaderUserId(user.getUserId());
